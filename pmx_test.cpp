...
{
  std::string filename = "D:\\MarisaV12\\MarisaV12\\MarisaVer12.pmx";
  std::string motionFilename = "/home/kazakami/download/Motion/tsuntsun.vmd";
  if (argc >= 2)
  {
    filename = argv[1];
  }
  ...
  //const std::string directory = "/export/home/012/a0126218/tmp/MarisaV12/";
  //const std::string directory = "/export/home/012/a0126218/tmp/KanataSanae/KanataSanae/";
 
  //pmx.readPMX((directory + "MarisaVer12.pmx").c_str());
